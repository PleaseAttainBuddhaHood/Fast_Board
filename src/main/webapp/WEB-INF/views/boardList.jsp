...
<script>
	...
	if(msg == "LIST_ERR")		alert("게시물 목록을 가져오는데 실패했습니다.");
	if(msg == "READ_ERR")		alert("삭제되었거나 없는 게시물입니다.");
	if(msg == "Delete_Error")	alert("삭제되었거나 없는 게시물입니다.");

	if(msg == "Delete_Success!") 	alert("글이 삭제되었습니다.");
	if(msg == "WRT_OK") 			alert("글이 등록되었습니다.");
	if(msg == "MOD_OK") 			alert("글이 수정되었습니다.");
</script>
...
<div style="text-align:center">
	<div class="board-container">
		<div class="search-container">
			...
			<button type="button" class="btn-write" id="writeBtn" onclick="location.href='<c:url value="/board/write" />'">
